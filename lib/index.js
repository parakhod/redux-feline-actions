...
const createActions = (actions, options = {}) => 
  ...
  Object.keys(actions).reduce((p,name) => ({
    ...
    [name]: (...params) => {
      ...
      const reducerName = getReducerName(
        payloadData.useReducer || 
      ...
      if (payloadData) {
        payload = {
          payload: payloadData.payload ? 
            typeof payloadData.payload === 'function' ? payloadData.payload() : payloadData.payload 
          : payloadData
        }
